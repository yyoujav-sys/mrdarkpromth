...
pub fn create_router(state: Arc<AppState>) -> Router {
    ...
    let protected_routes = Router::new()
        ...
        .route("/api/jailbreak/templates", get(handlers::list_templates_handler).post(handlers::create_template_handler))
        .route("/api/jailbreak/templates/{id}/generate", post(handlers::generate_from_template_handler))
