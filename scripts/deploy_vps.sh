...
cat > .env << 'ENVFILE'
# Production Environment - mrdarkpromth.online
...
certbot certonly --standalone -d mrdarkpromth.online -d www.mrdarkpromth.online --agree-tos --non-interactive --email mrdarkpromth2@gmail.com

# Copy certificates to app directory
mkdir -p /opt/mrdarkpromth/certs
cp /etc/letsencrypt/live/mrdarkpromth.online/fullchain.pem /opt/mrdarkpromth/certs/cert.pem
cp /etc/letsencrypt/live/mrdarkpromth.online/privkey.pem /opt/mrdarkpromth/certs/key.pem

# Auto-renewal cron job
echo "0 3 * * * certbot renew --quiet && cp /etc/letsencrypt/live/mrdarkpromth.online/fullchain.pem /opt/mrdarkpromth/certs/cert.pem && cp /etc/letsencrypt/live/mrdarkpromth.online/privkey.pem /opt/mrdarkpromth/certs/key.pem && cd /opt/mrdarkpromth && docker-compose restart nginx" | crontab -
...
echo "Website: https://mrdarkpromth.online"
echo "Grafana: https://mrdarkpromth.online/grafana"
echo "Prometheus: https://mrdarkpromth.online/prometheus"
echo ""
